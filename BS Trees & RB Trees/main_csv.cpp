...
{ 
    ...
    int size[7] = {50000, 100000, 250000, 500000, 1000000, 2500000, 5000000};
    tree = 1;
    ...
    for(int i= 0 ; i< 7; i++){
    	for(int direction = -1; direction<=1 ;direction ){
    		n = size[i];
    		myfile<<endl<<n<<";"<<direction<<endl<<endl<<endl<<endl;
    		for (int j = 0; j< 10; j++){
	// bs_info.reset();
	// rb_info.reset();
 ...
 */
	...
	myfile<<height<<";"<<rb.count_Duplicates()<<";"<<rb.count_Left()<<";"<<rb.count_Right()<<";"<<rb.count_Case1();
